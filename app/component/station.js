            ...
            <div class="flex flex-col flex-1 min-w-0 cursor-pointer">
                ...
                <span class="text-md text-gray-400 overflow-hidden flex gap-2 sm:gap-3">
                    ...
                    <span
                        ...
                        class="text-white/90 inline-flex items-center gap-[5px] bg-blue-600/70 rounded-[4px] text-[14px] px-[7px] invisible sm:visible"
                    >
                        <p class="-mt-[1px]">Restricted</p>
                    </span>
                    <span
                        v-if="station.is_broken"
                        class="text-white/90 inline-flex items-center gap-[5px] bg-red-600/70 rounded-[4px] text-[14px] px-[7px] invisible sm:visible"
                    >
                        <p class="-mt-[1px]">Broken</p>
                    </span>
                    <span
                        v-if="station.is_no_track_info"
                        class="text-white/90 inline-flex items-center gap-[5px] bg-green-600/70 rounded-[4px] text-[14px] px-[7px] invisible sm:visible"
                    >
